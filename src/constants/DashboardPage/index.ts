...
export const DEFAULT_PERIOD_DAYS = 7 as const;
export const PERIOD_PRESETS = [7, 14, 30] as const;
export const DATE_RANGE_FILTER_GAP = 1.5;
export const DATE_RANGE_CHIP_RADIUS = START_DEID_BUTTON_RADIUS;
export const DATE_RANGE_CHIP_HEIGHT = 32;
export const DATE_RANGE_POPOVER_MIN_WIDTH = 260;
export const DATE_PICKER_INPUT_HEIGHT = 36;
export const DATE_PICKER_BORDER_WIDTH = 1;
export const MS_PER_DAY = 86_400_000;
export const ACTIVITY_LIMIT_MAX = 100;
export const DATE_FORMAT_ISO = "YYYY-MM-DD";
export const ADAPTER_LOCALE = "en-gb";
export const CHIP_TRANSITION_DURATION = "0.18s";
export const CHIP_TRANSITION = `background-color ${CHIP_TRANSITION_DURATION} ease, border-color ${CHIP_TRANSITION_DURATION} ease, color ${CHIP_TRANSITION_DURATION} ease`;
export const PRIMARY_HOVER_ALPHA = "14";
