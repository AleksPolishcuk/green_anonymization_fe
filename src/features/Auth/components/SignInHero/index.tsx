...
import { EnterpriseParagraph, ShieldLogo, StatItem, StatLabel, Stats, StatValue, WelcomeHeading } from "./styles";
...
export default function SignInHero() {
    ...
    return (<>
            ...
            <WelcomeHeading>{t("hero.title1")}<br/>{t("hero.title2")}</WelcomeHeading>
