...
import { shieldGrowDuration, headingDelay, paragraphDelay, statsDelayOne, statsDelayTwo, statsDelayThree, heroRevealDuration, fadeUp, staggerItem } from "constants/auth";
